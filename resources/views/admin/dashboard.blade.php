                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-8">
                                        <p class="text-center">
                                            <strong>
                                                Sales: {{ now()->subMonths(11)->format('M Y') }} -
                                                {{ now()->format('M Y') }}
                                            </strong>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="progress-group">
                                            ...
                                            <div class="progress progress-sm">
                                                <div class="progress-bar bg-primary" style="width: {{ $cartPercent }}%">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="progress-group">
                                            ...
                                            <div class="progress progress-sm">
                                                <div class="progress-bar bg-danger" style="width: {{ $completedPercent }}%">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="progress-group">
                                            ...
                                            <div class="progress progress-sm">
                                                <div class="progress-bar bg-success" style="width: {{ $pendingPercent }}%">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="direct-chat-messages">
                                            @foreach($latestMessages as $msg)
                                                <div class="direct-chat-msg">
                                                    ...
                                                    <img class="direct-chat-img" src="{{ asset('admin/img/user.png') }}">
                                        ...
                                        <div class="direct-chat-contacts">
                                            <ul class="contacts-list">
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                            src="{{url('admin/img/user1-128x128.jpg')}}">
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                            src="{{url('admin/img/user7-128x128.jpg')}}">
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                            src="{{url('admin/img/user3-128x128.jpg')}}">
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                            src="{{url('admin/img/user5-128x128.jpg')}}">
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                            src="{{url('admin/img/user6-128x128.jpg')}}">
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                            src="{{url('admin/img/user8-128x128.jpg')}}">
                                    ...
                                    @foreach($latestProducts as $product)
                                        <li class="item">
                                            <div class="product-img">
                                                <img src="{{ asset($product->image_url) }}" class="img-size-50">
                                            </div>
